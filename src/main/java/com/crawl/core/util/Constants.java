...
public class Constants {
     ...
     * 网易云音乐首页
     */
    public final static String INDEX_URL = "https://music.163.com";

    /**
     * 获取评论的API路径(被加密)
     */
    public static final String COMMENTURL = "https://music.163.com/weapi/v1/resource/comments/R_SO_4_{id}?csrf_token=";

    /**
     *  解密用的文本
     */
    public static final String TEXT = "{\"username\": \"\", \"rememberLogin\": \"true\", \"password\": \"\",\"offset\":\"{offset}\"}";
    //默认获取评论数10
    public static final String DEFALT_TEXT = "{\"username\": \"\", \"rememberLogin\": \"true\", \"password\": \"\"}";

    /**
     * 用户页面
     */
    public final static String USER_FOLLOWEES_URL = "https://music.163.com/playlist?id=159866743";
